...
; If one of the digits in the pin is outside of the valid range for that digit,
; the pin will be invalid and the position of the invalid digit will be placed in eax.
